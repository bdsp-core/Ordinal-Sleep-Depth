...
df_test_all = df_test_all[df_test_all['age']>17]
...
# Example: Assuming label, OSD, and ORP are lists of equal length
df = pd.DataFrame({
...
# Tukey’s HSD test
tukey = pairwise_tukeyhsd(endog=df_sample["sleep_depth"], 
                           groups=df_sample["sleep_stage"], 
                           alpha=0.05)
