...
master_csv = pd.read_csv(f'{WORKING_DIRECTORY}/OSD/data_splits/final_split/test_subjects.csv')
list_of_csv_files = glob(f'{WORKING_DIRECTORY}/OSD/predictions/OSD_FINAL/*.csv')
